...
namespace Hoard.Core.Data.Migrations
{
    ...
    [Migration("20251207215627_RemoveWeightPercentages")]
    partial class RemoveWeightPercentages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hoard.Core.Domain.Entities.Valuation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hoard.Core.Domain.Entities.Valuation", b =>
                {
                    b.HasOne("Hoard.Core.Domain.Entities.Holding", "Holding")
                        .WithOne("Valuation")
                        .HasForeignKey("Hoard.Core.Domain.Entities.Valuation", "HoldingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
