...
// Kicks off the full revaluation sequence
public record BackfillValuationsCommand(DateOnly StartDate, DateOnly EndDate);

// Internal step message — saga sends one per day
